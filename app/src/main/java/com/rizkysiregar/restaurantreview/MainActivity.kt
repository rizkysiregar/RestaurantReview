package com.rizkysiregar.restaurantreview
...
import com.rizkysiregar.restaurantreview.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun postReview(review: String){
        showLoading(true)
        val client = ApiConfig.getApiService().postReview(RESTAURANT_ID,"Habib Rizky A.Siregar",review)
